...
// remembering minSoFar - thus comes under DP
public class Stocks1 {
    ...
    // preprocessing - make aux array from the end storing maxSoFar prices - then
    // cal diff on same index - calc maxProfit
    ...
    // brute force - 2 loops - one for buy other for sell on all forward days -
    // return maxProfit - O(n^2), O(1)
