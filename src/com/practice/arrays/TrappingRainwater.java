...
public class TrappingRainwater {
    ...
    // using space to reduce max element search time
    ...
    public static int trapOptimized(int[] height) {
        ...
        while(left<=right) {
            // intuition: this condition makes sure there is someone with greater height on right
            ...
            if(height[left] <= height[right]) {
                if(height[left] >= leftMax) {
                    ...
                    // store water - maxleft minus current height
