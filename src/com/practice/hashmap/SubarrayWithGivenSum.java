...
public class SubarrayWithGivenSum {
    ...
    // usually for subarrays, the brute force is to find all the subarrays and check the conditions - O(n^2)
    ...
    // store currsum with index in hashmap - in the loop look for currsum-sum - answer is index+1 till i
